...
class fake_arduino():
        def __init__(self,sender_username,reciever_username):
        ...
        def recieve_serial_data(self):
                ...
                if(len(device_input_data) > 0):
                        ...
                        self.color_print(decoded_message,sender_username,'cyan')
        ...
        def color_print(self,message,username,color_select):
                self.backspace_printed_string(reciever_username)
...
if __name__ == "__main__":
        ...
        pro_mini = fake_arduino(sender_username,reciever_username)
        baud_rate = 9600
        timeout_length = .2
